...
ENV Z2M_VERSION_=fd2aa6e67bb7c4bee75babd83fc1b5369145b6bf
ENV Z2M_VERSION=master
...
RUN npm config set unsafe-perm true && npm install -g pkg@4.3.8 \
  && cd /root \
  && git clone https://github.com/bjornreppen/Zwave2Mqtt.git  \
  && cd Zwave2Mqtt \
